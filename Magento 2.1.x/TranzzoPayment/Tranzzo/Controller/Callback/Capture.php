...
class Capture extends Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
	protected $_context;
	protected $_request;
	...
	{
		$this->_paymentModel->processCapture($this->_request->getParams(), $this->_orderFactory);
	}
