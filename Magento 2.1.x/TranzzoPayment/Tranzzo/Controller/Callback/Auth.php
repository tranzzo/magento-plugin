...
class Auth extends Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
	protected $_context;
	protected $_request;
	...
	{
		$this->_paymentModel->processAuth($this->_request->getParams(), $this->_orderFactory);
	}
